            ...
            if (
                ...
                this.setState({
                    error: {
                        error: true,
                        message:
                            'Both, email & password fields are required to continue.',
                    },
                    emailInvalid: true,
                ...
                if (!validateEmail(account.email)) {
                    ...
                    this.setState({
                        error: {
                            error: true,
                            message:
                                'The password field requires at least one upper case and one lower case English character, at least one digit, at least one special character, and be at least 8 characters in length to be valid.',
                        },
                        passwordInvalid: true,
                    });
                }
                    ...
                    onBlur={(e) => {
                        ...
                        if (validateEmail(email)) {
                            ...
                            if (email === '') {
                                this.setState({
                                    emailInvalidText:
                                        'The Email Address field must not empty.',
                                    emailInvalid: true,
                                });
                            } else {
                                this.setState({
                    ...
                    onBlur={(e) => {
                        ...
                        if (validatePassword(password)) {
                            ...
                            if (password === '') {
                                this.setState({
                                    passwordInvalidText:
                                        'The Password field must not empty.',
                                    passwordInvalid: true,
                                });
                            } else {
                                this.setState({
