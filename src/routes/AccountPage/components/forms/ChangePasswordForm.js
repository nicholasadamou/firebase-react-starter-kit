...
class ChangePasswordForm extends Component {
    ...
    validatePassword = (e, password) => {
        ...
        const target = {
            name:
                e.target.name === 'passwordOne' ? 'passwordTwo' : 'passwordOne',
            password,
        };
        ...
        if (!validatePassword(cell.password)) {
            this.setState({
                ...
                [`${cell.name}InvalidText`]: 'At least one upper case and one lower case English character, at least one digit, at least one special character, and be at least 8 characters in length.',
            });
    ...
    render() {
        ...
        return (
            <Wrapper>
                ...
                <Form
                    onSubmit={(e) =>
                        this.handleChangePassword(e, passwordOne, password)
                    }
                >
                    <PasswordInput
                        id="password"
