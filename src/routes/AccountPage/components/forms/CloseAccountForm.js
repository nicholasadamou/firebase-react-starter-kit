                                    ...
                                    users.forEach((user) => {
                                        ...
                                        if (user.id !== currentUser.uid) {
                                            ...
                                            if (user.matches.length !== 0) {
                                                ...
                                                if (
                                                    user.matches.includes(
                                                        currentUser
                                                    )
                                                ) {
                                                    firebase
                                                        .ref(
                                                            `users/${user.id}/matches/${currentUser.uid}`
                                                        )
                                                        .remove();
                                                }
                                            }
                                            ...
                                            if (user.rejections.length !== 0) {
                                                ...
                                                if (
                                                    user.rejections.includes(
                                                        currentUser
                                                    )
                                                ) {
                                                    firebase
                                                        .ref(
                                                            `users/${user.id}/rejections/${currentUser.uid}`
                                                        )
                                                        .remove();
                                                }
                                            }
        ...
        return (
            <Wrapper>
                ...
                <p>
                    ...
                    : Closing an account is a sensitive process and once
                    completed, it <strong>cannot</strong> be undone. If you are{' '}
                    <strong>sure</strong> you want to close your account, type
                    in your <em>current password</em> and press the{' '}
                    <em>Close my account</em> button.
                </p>
